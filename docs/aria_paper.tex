...
%
% IMAGE ATTACHMENT GUIDE (search for %%IMAGE in this file):
...
%   fig_architecture.png           — System architecture block diagram (CREATE MANUALLY)
%   fig_rl_reward_curve.png        — RL training reward curve (from TensorBoard screenshot)
%   fig_llm_pipeline.png           — NL → MissionPlan pipeline diagram (CREATE MANUALLY)
%   fig_simulation_screenshot.png  — Screenshot from PyFlyt/AirSim simulation
% =====================================================================
